  ...
  return (
    <div className='editprofile-wrapper'>
        ...
        <form action="" className='editprofile-form' onSubmit={handleSubmit}>
            ...
            {showPasswordFields && (
                <>
                <Input label={"Current Password"} type={"password"} value ={"currentPassword"} placeholder={"Enter current password"} onChange ={(e) => setCurrentPassword(e.target.value)} />

                <Input label={"New Password"} type={"password"} value ={"newPassword"} placeholder={"Enter new password"} onChange ={(e) => setNewPassword(e.target.value)} />
            ...
            <div className="editprofile-actions">
                <button type='button' className='editprofile-btn-cancel' onClick={onClose} disabled={isLoading}>
                    Cancel
                </button>
